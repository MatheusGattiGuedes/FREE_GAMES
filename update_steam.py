...
# # Header comum para as duas requisições
# headers = {
...
#         # 2. BUSCA ROBUSTA DE IMAGENS (Cobre jogos normais e Mystery Games)
#         image = None
...
#         # 3. EXTRAÇÃO DE PREÇOS (Para você saber se é de graça ou se tem só desconto)
...
#         # TRAVA PARA PEGAR APENAS OS JOGOS 100% GRATUITOS
...
# # url_steam = "https://store.steampowered.com/search/?maxprice=free&supportedlang=brazilian&specials=1&hidef2p=1&ndl=1"
...
#         # Extrai URL limpa e AppID
#         game_url = item.get('href', '').split('?')[0]
#         app_id = item.get('data-ds-appid')
#         if not app_id: continue
            
#         # ==========================================
#         # NOVA BUSCA DE IMAGEM PELA DIV SEARCH_CAPSULE
#         # ==========================================
#         image_url = ""
...
#                 # Pega a URL exata que a Steam carregou (e remove o parâmetro ?t= do final para ficar limpo)
...
if novos_jogos:
    ...
    for novo_jogo in novos_jogos:
        msg = f"🚨 *NOVO JOGO GRÁTIS NA {novo_jogo['store'].upper()}!* 🚨\n\n"
        msg += f"*{novo_jogo['title']}*\n"
        msg += f"Preço original: ~{novo_jogo['original_price']}~\n"
        msg += f"Resgata aqui: [Link da Loja]({novo_jogo['url']})"
